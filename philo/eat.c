...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/10 12:50:00 by fforlini          #+#    #+#             */
/*   Updated: 2022/05/10 12:56:48 by fforlini         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	pthread_mutex_lock(&philo->philo_stats->forks[philo->l_fork]);
	print_action(philo, "has taken a fork");
	pthread_mutex_lock(&philo->philo_stats->forks[philo->r_fork]);
	print_action(philo, "has taken a fork");
	pthread_mutex_lock(&philo->philo_stats->lock_meal);
	...
	philo->n_meals++;
	pthread_mutex_unlock(&philo->philo_stats->forks[philo->l_fork]);
	pthread_mutex_unlock(&philo->philo_stats->forks[philo->r_fork]);
	return (0);
}
